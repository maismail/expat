...
public class TakeSnapshot extends SnapshotRepo {
  
  private void takeSnapshot() throws ConfigurationException, IOException, URISyntaxException, NoSuchAlgorithmException,
                                     KeyStoreException, KeyManagementException {
    LOGGER.info("take elastic snapshot");
    setup();
    ...
    ElasticClient.takeSnapshot(httpClient, elastic, elasticUser, elasticPass,
      snapshotRepoName, snapshotName, ignoreUnavailable, snapshotIndices);
  }
