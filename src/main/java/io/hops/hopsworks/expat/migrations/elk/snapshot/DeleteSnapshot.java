...
public class DeleteSnapshot extends SnapshotRepo {
  
  private void deleteSnapshot() throws IOException, URISyntaxException, NoSuchAlgorithmException, KeyStoreException,
                                       ConfigurationException, KeyManagementException {
    LOGGER.info("delete elastic snapshot");
    setup();
    ...
    ElasticClient.deleteSnapshot(httpClient, elastic, elasticUser, elasticPass, snapshotRepoName, snapshotName);
  }
