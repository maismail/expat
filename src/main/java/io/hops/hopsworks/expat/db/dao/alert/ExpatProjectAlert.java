...
public class ExpatProjectAlert extends ExpatAbstractEntity<ExpatProjectAlert> {
  private Integer id;
  ...
  @Override
  public ExpatProjectAlert getEntity(ResultSet resultSet) throws SQLException {
